...
public class ArrayIntro {
    public static void main(String[] args) {
        ...
        String [] cities = {"Chicago", "New York", "Houston", "Denver", "Pittsbourgh"};
        ...
        System.out.println(cities); // this doens't print the Array how we want
        System.out.println(Arrays.toString(cities));// this method from arrays class lets you print the array fully

        //number of elements
        System.out.println("Number of elements in an Array: " + cities.length);
