...
public class Bank {
    ...
    // in this method we throw checked exceptions, so they must be handled, but we created the class so we don't
    // handle them. We use throws to allow the program to compile, so the user of the class handles the exceptions
