...
public class DataBaseExample {
    public static void main(String[] args) {
        ...
        //how can I check the last name of the map is just added?
        System.out.println(list.get(1).get("FIRST_NAME"));// first "get" is from the list by index, then we hav ethe
        // get method from map to give the value by the key
        ...
        System.out.println("=====================");
        //Print the inforamtion of the last person in my List
        // the first get call is the List method, to get the second element based on the index the second get method
        // is from the map, to get the value based on the key
