...
public class RemoveCountries {
    ...
    public static void main(String[] args) {
        ArrayList<String> listOfCountries = new ArrayList<>(Arrays.asList("Japan", "Korea", "United States", "Turkey", "United Kingdom", "Canada"));
        System.out.println(removeCountries(listOfCountries));
    }
